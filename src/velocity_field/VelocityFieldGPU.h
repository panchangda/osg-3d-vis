...
namespace VelocityFieldGPU {
	...
	public:
		...
		void createCalculateSpeedPass() {
            ...
            mainCamera->addChild(calculateSpeedRTTCamera.get());
...
//            stateset->setRenderingHint(osg::StateSet::TRANSPARENT_BIN);
		...
		void createUpdatePositionPass() {
            ...
            mainCamera->addChild(updatePositionRTTCamera);
		...
		void createDrawLinesPass() {
            ...
            mainCamera->addChild(drawLinesRTTCamera);
		...
		void createDrawArrowsPass(){
			...
			mainCamera->addChild(drawArrowsRTTCamera);
		...
		void createCopyCurrentParticleToPrevParticlePass() {
            ...
            mainCamera->addChild(copyCurrentParticleToPrevParticleRTTCamera);
		...
		void createCopyNextParticleToCurrentParticlePass() {
            ...
            mainCamera->addChild(copyNextParticleToCurrentParticleRTTCamera);
		...
		void createBlendPass() {
            ...
            mainCamera->addChild(blendTexRTTCamera);
		...
		void createCopyblendTexToLastFrameTexPass() {
            ...
            mainCamera->addChild(copyblendTexToLastFrameTexRTTCamera);
...
//                        osg::ref_ptr<osg::Geometry> renderPassGeometry = createScreenQuad();
		...
		void reDraw(){
			...
			range = llhRange(minLat, maxLat, minLon, maxLon, range.minHeight, range.maxHeight);
...
#if defined(_WIN32)
		sl->setShaderPath("E:/osg-vis/shaders/");
		sl->initFromDatFile("E:/osg-vis/data/U.DAT", "E:/osg-vis/data/V.DAT", range);
		//sl->initFromConfigFile("E:/osg-vis/config");
#else
                sl->setShaderPath(std::string(OSG_3D_VIS_SHADER_PREFIX) + "old-shaders/");
